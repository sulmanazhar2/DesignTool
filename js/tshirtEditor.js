...
$(document).ready(function () {
    ...
    $(".image-picker").imagepicker({
        clicked: function () {
            $('#tshirttype option[value="' + $(this).find("option[value='" + $(this).val() + "']").data('img-src') + '"]').prop('selected', 'selected');
    ...
    $(document).on("click", ".img-polaroid", function (e) {
        ...
        $("#layerUI").prepend('<li draggable="true" id="' + id + '" class="layersList"><img class="layersimg" src="' + el.src + '"><span class="layerstxt" title="Layer ' + (id + 1) + '">Layer ' + (id + 1) + '</span><span class="layersfunc"><i class="layers-icon-close fa fa-times" title="Delete layer" data-act="delete" onclick="delete_objects(' + id + ')"></i></span></li>');
...
(function () {
    ...
    function activatingFilters() {
        if (canvas.getActiveObject().type == 'image') {
            fabric.util.toArray(document.getElementsByClassName('FilterClass'))
                .forEach(function (el) {
                    el.disabled = false;
                })
    ...
    if (e === undefined) {
        ...
        if (o._objects === undefined) {
            ...
            o._objects.forEach(function (object) {
                ...
                s = canvas.getActiveObject() && canvas.getObjects().indexOf(canvas.getActiveObject());
                $("#" + s).remove();
            });
            o._objects.forEach(function (object) {
...
function jsonLayers(e) {
    ...
    for (l; l >= 0; l--) {
        $("#layerUI").append('<li draggable="true" id="' + l + '" class="layersList"><img class="layersimg" src="' + b[l].src + '"><span class="layerstxt" title="Shape ' + (l + 1) + '">Shape ' + (l + 1) + '</span><span class="layersfunc"><i class="layers-icon-close fa fa-times" title="Delete layer" data-act="delete" onclick="delete_objects(' + l + ')"></i></span></li>');
    }
...
function jsonLayers2() {
    ...
    for (l; l >= 0; l--) {
        if (b[l].__proto__.type == "image") {
            $("#layerUI").append('<li draggable="true" id="' + l + '" class="layersList"><img class="layersimg" src="' + b[l]._element.currentSrc + '"><span class="layerstxt" title="Image Layer">Layer ' + (l + 1) + '</span><span class="layersfunc"><i class="layers-icon-close fa fa-times" title="Delete layer" data-act="delete" onclick="delete_objects(' + l + ')"></i></span></li>');
        } else if (b[l].__proto__.type == "text") {
            $("#layerUI").append('<li draggable="true" id="' + l + '" class="layersList"><img class="layersimg" src="icons/text.svg"><span class="layerstxt" title="Text Layer">Layer ' + (l + 1) + '</span><span class="layersfunc"><i class="layers-icon-close fa fa-times" title="Delete layer" data-act="delete" onclick="delete_objects(' + l + ')"></i></span></li>');
        } else {
            $("#layerUI").append('<li draggable="true" id="' + l + '" class="layersList"><img class="layersimg" src="icons/artist.svg"><span class="layerstxt" title="Drawing Layer">Layer ' + (l + 1) + '</span><span class="layersfunc"><i class="layers-icon-close fa fa-times" title="Delete layer" data-act="delete" onclick="delete_objects(' + l + ')"></i></span></li>');
        }
    }
...
function pngImage() {
    ...
    domtoimage.toBlob(document.getElementById('tcanvas'))
        .then(function (blob) {
            window.saveAs(blob, 'CreateEzee.png');
            console.log(blob);
        });
}
